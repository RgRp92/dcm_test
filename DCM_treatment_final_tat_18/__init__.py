...
def choice_binding(player, group):
    if group.binding_sit == 1:
        return player.CE1_choice
    if group.binding_sit == 2:
        return player.CE2_choice
    if group.binding_sit == 3:
        return player.CE3_choice
    if group.binding_sit == 4:
        return player.CE4_choice
    if group.binding_sit == 5:
        return player.CE5_choice

    if group.binding_sit == 6:
        return player.CE6_choice

    if group.binding_sit == 7:
        return player.CE7_choice

    if group.binding_sit == 8:
        return player.CE8_choice

    if group.binding_sit == 9:
        return player.CE9_choice



def group_pre_A_(player):
    if player.group.binding_sit == 1:
        return player.CE1_pred_A
    if player.group.binding_sit == 2:
        return player.CE2_pred_A
    if player.group.binding_sit == 3:
        return player.CE3_pred_A
    if player.group.binding_sit == 4:
        return player.CE4_pred_A
    if player.group.binding_sit == 5:
        return player.CE5_pred_A
    if player.group.binding_sit == 5:
        return player.CE5_pred_A
    if player.group.binding_sit == 6:
        return player.CE6_pred_A
    if player.group.binding_sit == 7:
        return player.CE7_pred_A
    if player.group.binding_sit == 8:
        return player.CE8_pred_A
    if player.group.binding_sit == 9:
        return player.CE9_pred_A


def group_pre_B_(player):
    if player.group.binding_sit == 1:
        return player.CE1_pred_B
    if player.group.binding_sit == 2:
        return player.CE2_pred_B
    if player.group.binding_sit == 3:
        return player.CE3_pred_B
    if player.group.binding_sit == 4:
        return player.CE4_pred_B
    if player.group.binding_sit == 5:
        return player.CE5_pred_B
    if player.group.binding_sit == 6:
        return player.CE6_pred_B
    if player.group.binding_sit == 7:
        return player.CE7_pred_B
    if player.group.binding_sit == 8:
        return player.CE8_pred_B
    if player.group.binding_sit == 9:
        return player.CE9_pred_B


def group_pre_C_(player):
    if player.group.binding_sit == 1:
        return player.CE1_pred_C
    if player.group.binding_sit == 2:
        return player.CE2_pred_C
    if player.group.binding_sit == 3:
        return player.CE3_pred_C
    if player.group.binding_sit == 4:
        return player.CE4_pred_C
    if player.group.binding_sit == 5:
        return player.CE5_pred_C
    if player.group.binding_sit == 6:
        return player.CE6_pred_C
    if player.group.binding_sit == 7:
        return player.CE7_pred_C
    if player.group.binding_sit == 8:
        return player.CE8_pred_C
    if player.group.binding_sit == 9:
        return player.CE9_pred_C
...
class Questionario_9(Page):
    ...
    def is_displayed(player: Player):
        ...
        return   residente_trento == 1    and player.participant.accept ==1
...
class Practice_results_no_replace_1(Page):
    @staticmethod
    def is_displayed(player: Player):
        return  player.participant.replace_predictions_practice ==0 and player.participant.accept ==1
...
class Practice_results_replace_1(Page):
    @staticmethod
    def is_displayed(player: Player):
        return  player.participant.replace_predictions_practice ==1 and player.participant.accept ==1
...
class Practice_payoff_not_replaced(Page):
    @staticmethod
    def is_displayed(player: Player):
        return  player.participant.accept ==1 and player.participant.replace_predictions_practice ==0
...
class Practice_payoff_replaced(Page):
    @staticmethod
    def is_displayed(player: Player):
        return player.participant.accept ==1 and player.participant.replace_predictions_practice ==1
...
class binding_situation(Page):
    ...
    def js_vars(player):
        return dict(  binding=player.group.binding_sit)
...
class your_choice_binding(Page):
    ...
    @staticmethod
    def vars_for_template(player):
        true_binding_situation =  player.group.binding_sit
...
class your_prediction_no_replaced(Page):
    @staticmethod
    def is_displayed(player: Player):
        return player.participant.replace_predictions ==0 and player.participant.accept ==1
...
class your_prediction_replaced(Page):
    ...
    @staticmethod
    def is_displayed(player: Player):
        return player.participant.replace_predictions ==1 and player.participant.accept ==1
...
class your_payoff_not_replaced(Page):
    @staticmethod
    def is_displayed(player: Player):
        return player.participant.accept ==1 and player.participant.replace_predictions ==0
...
class your_payoff_replaced(Page):
    @staticmethod
    def is_displayed(player: Player):
        return player.participant.accept ==1 and player.participant.replace_predictions ==1
